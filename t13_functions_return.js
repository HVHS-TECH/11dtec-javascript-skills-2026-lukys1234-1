...
calculateChange=(_money_price);

function calculateChange(_money_price){
let calculateChange = _money_price;

const MONEY_FIELD = document.getElementById("moneyField");
OUTPUT.innerHTML += "<p> Your have is"+calculateChange+ "change</p1>"
}
